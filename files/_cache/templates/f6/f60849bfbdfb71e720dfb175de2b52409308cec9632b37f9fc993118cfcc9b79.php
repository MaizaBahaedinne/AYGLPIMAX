...
class __TwigTemplate_299eb01cc4929ad96667aef5bf0889a62726453e1e5b8f0bedc5083740121261 extends Template
{
    private $source;
    private $macros = [];
...
($context["field_options"] ?? null)], 78, $context, $this->getSourceContext());
        ...
        <input type=\"hidden\" name=\"items_id\" value=\"";
            // line 84
            echo twig_escape_filter($this->env, (($__internal_compile_7 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 84)) && is_array($__internal_compile_7) || $__internal_compile_7 instanceof ArrayAccess ? ($__internal_compile_7["items_id"] ?? null) : null), "html", null, true);
            echo "\">
...
($context["field_options"] ?? null)], 112, $context, $this->getSourceContext());
        ...
        ";
            // line 119
            echo twig_call_macro($macros["fields"], "macro_htmlField", ["last_contact", $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Html::convDateTime", [(($__internal_compile_10 = twig_get_attribute($this->env, $this->source,             // line 121
...
($context["field_options"] ?? null), ["min" => 1, "toadd" => [                // line 146
($context["general"] ?? null)]])], 139, $context, $this->getSourceContext());
        ...
        <h2 class=\"header\">";
            // line 152
            echo twig_escape_filter($this->env, __("Supported tasks"), "html", null, true);
            echo "*</h2>
        ...
        ";
            ...
            // line 173
            echo "        <i>* ";
            echo twig_escape_filter($this->env, __("when reported by GLPI agent via native inventory"), "html", null, true);
            echo "</i>
    ";
        }
    }
